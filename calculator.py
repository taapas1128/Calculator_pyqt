...
class Ui_Dialog(object):
	...
	self.range = QtGui.QPushButton(Dialog)
        self.range.setGeometry(QtCore.QRect(80, 470, 61, 51))
        self.range.setObjectName(_fromUtf8("range"))
	self.plot = QtGui.QPushButton(Dialog)
        self.plot.setGeometry(QtCore.QRect(150, 470, 61, 51))
	...
	self.comma = QtGui.QPushButton(Dialog)
        self.comma.setGeometry(QtCore.QRect(290, 470, 61, 51))
	...
	self.range.setText(_translate("Dialog", "range", None))
