...
"}"))
        ...
        self.sin1.setGeometry(QtCore.QRect(380, 110, 51, 111))
        self.sin1.setObjectName(_fromUtf8("sin1"))
        self.cos1 = QtGui.QPushButton(Dialog)
        self.cos1.setGeometry(QtCore.QRect(380, 230, 51, 111))
        self.cos1.setObjectName(_fromUtf8("cos1"))
        self.tan1 = QtGui.QPushButton(Dialog)
        self.tan1.setGeometry(QtCore.QRect(380, 350, 51, 111))
