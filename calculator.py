...
"}"))
        ...
        self.decimal.setGeometry(QtCore.QRect(150, 410, 41, 51))
        ...
        self.clear.setGeometry(QtCore.QRect(340, 290, 41, 51))
        self.clear.setObjectName(_fromUtf8("clear"))
        self.back = QtGui.QPushButton(Dialog)
        self.back.setGeometry(QtCore.QRect(290, 290, 41, 51))
        ...
        self.divide.setGeometry(QtCore.QRect(150, 290, 61, 51))
        ...
        self.power.setGeometry(QtCore.QRect(200, 410, 61, 51))
        ...
        self.e.setGeometry(QtCore.QRect(270, 410, 61, 51))
        self.e.setObjectName(_fromUtf8("e"))
        self.pi = QtGui.QPushButton(Dialog)
        self.pi.setGeometry(QtCore.QRect(340, 410, 41, 51))
        ...
        self.r1.setGeometry(QtCore.QRect(290, 230, 91, 51))
        self.r1.setObjectName(_fromUtf8("r1"))
        self.sin1 = QtGui.QPushButton(Dialog)
        self.sin1.setGeometry(QtCore.QRect(10, 350, 51, 51))
        self.sin1.setObjectName(_fromUtf8("sin1"))
        self.cos1 = QtGui.QPushButton(Dialog)
        self.cos1.setGeometry(QtCore.QRect(70, 350, 51, 51))
        self.cos1.setObjectName(_fromUtf8("cos1"))
        self.ln1 = QtGui.QPushButton(Dialog)
        self.ln1.setGeometry(QtCore.QRect(190, 350, 51, 51))
        self.ln1.setObjectName(_fromUtf8("ln1"))
        self.log1 = QtGui.QPushButton(Dialog)
        self.log1.setGeometry(QtCore.QRect(250, 350, 61, 51))
        self.log1.setObjectName(_fromUtf8("log1"))
        self.squar = QtGui.QPushButton(Dialog)
        self.squar.setGeometry(QtCore.QRect(320, 350, 61, 51))
        self.squar.setObjectName(_fromUtf8("squar"))
        self.tan1 = QtGui.QPushButton(Dialog)
        self.tan1.setGeometry(QtCore.QRect(130, 350, 51, 51))
        self.tan1.setObjectName(_fromUtf8("tan1"))
        self.r2 = QtGui.QRadioButton(Dialog)
        self.r2.setGeometry(QtCore.QRect(290, 170, 91, 51))
        self.r2.setObjectName(_fromUtf8("r2"))
        self.r3 = QtGui.QRadioButton(Dialog)
        self.r3.setGeometry(QtCore.QRect(290, 110, 91, 51))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ln1.setText(_translate("Dialog", "e^x", None))
        self.log1.setText(_translate("Dialog", "10^x", None))
        self.squar.setText(_translate("Dialog", "x^2", None))
        self.tan1.setText(_translate("Dialog", "tan-1", None))
        self.r2.setText(_translate("Dialog", "Inverse", None))
        self.r3.setText(_translate("Dialog", "Normal", None))
