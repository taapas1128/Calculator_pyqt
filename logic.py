...
class calculator_class(calculator.Ui_Dialog,QtGui.QMainWindow):
	...
	def __init__(self):
		...
		self.range.clicked.connect(lambda:self.disp_eqn(' range( '))### Hmm..... Okay....
		self.range.clicked.connect(lambda:self.store_range(' range( '))### Hmm..... Okay....
		self.plot.clicked.connect(self.print_graph)	#Okay.... fine....
