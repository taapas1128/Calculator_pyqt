...
For Windows download wheel file from [here](https://www.lfd.uci.edu/~gohlke/pythonlibs/#pyqt4) & Then locate the download file directory & Run `pip install .\pyqt4-file-name.whl` in command prompt or powershell.
...
* `calculator.ui` is the UI design used which can be created by PyQt Designer GUI. For UI modification you can install PyQt designer which can be installed for linux based OS as given [here](https://askubuntu.com/questions/763877/how-to-install-and-run-qt-designer-for-python). For windows download it from [here](https://www.qt.io/download) .
